//The following code provides the following functions:

//AutPn(points,images), which returns an automorphism of the projective space given minimal sets of points and images in general position.

//AutQuadSurf(M1,M2,s). Given an automorphism f=(M1,M2,s) of P1xP1, this function returns the automorphism of P^3 which restricts to f in the automorphism group of the quadric which is the Segre embedding of P1xP1.

//SGPGL(matrices), which returns the subgroup of PGL_n(C) generated by a given set of matrices.

//SGAutP1P1(triples), which returns the subgroup of PGL_4(C) inducing the subgroup of automorphisms of P1xP1 given by a set of automorphisms of P1xP1.
...
F2:=E*F*E^2*F*E^-1;//It is the image of F by an automorphism of A5 which is not internal. E is its own image by this automorphism. (Double check all this.)
...
//Checking the GAP IDs in Proposition 5.13:
